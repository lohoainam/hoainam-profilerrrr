                        ...
                        <ul class="extend active">
                            <li class="extend-item">
                                ...
                                <p class="extend-item-para">
                                    Mình là một Deverloper tự do. Mình đang làm về các lĩnh vực Website Game, Designer, Coder.
                                </p>
                                <p class="extend-item-para">
                            ...
                            <li class="extend-item">
                                <div class="extend-item--title-body">
                                    <h3 class="extend-item--h3">Dịch Vụ Riêng</h3>
                                </div>
                                <div class="slide">
                                    <!-- Từng câu nói -->
                                    <div class="slide-users active fade">
                                        <div class="slide-avatar">
                                            <img src="https://i.imgur.com/mCyweec.jpg" alt="" class="slide-avatar--img">
                                        </div>
                                        <div class="slide-text fade">
                                            <h4 class="slide-text--title">Đặng Đức Khanh</h4>
                                            <p class="slide-text--para">
                                                Bạn cũng có thể book mình làm Website theo yêu cầu giá hợp lý. Nếu có thể bạn ib Facebook để được mình hỗ trợ nhé!
                                            </p>
                                        </div>
                                    </div>
